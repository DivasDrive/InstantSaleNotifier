...
public class PermissionUtils
{
    ...
    public void check_permission(ArrayList<String> permissions, String dialog_content, int request_code)
    {
        ...
        if(Build.VERSION.SDK_INT >= 23)
        {
            ...
            {
                isPermissionGranted = permissionResultCallback.PermissionGranted(request_code);
    ...
    {
        boolean PermissionGranted(int request_code);
        void PartialPermissionGranted(int request_code, ArrayList<String> granted_permissions);
        boolean PermissionDenied(int request_code);
